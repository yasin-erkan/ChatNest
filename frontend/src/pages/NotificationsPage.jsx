              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {incomingRequests.map((request) => {
                    if (!request?._id || !request?.sender) return null;
                        ...
                        <div className="card-body p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <h3 className="font-semibold">{request.sender.fullName || 'Anonymous User'}</h3>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {acceptedRequests.map((notification) => {
                    if (!notification?._id || !notification?.recipient) return null;
                        ...
                        <div className="card-body p-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold">{notification.recipient.fullName || 'Anonymous User'}</h3>
