            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">
                  ChatNest is a platform for language learners to connect with others and practice their language skills.
                  You can send friend requests to other users and start chatting with them.
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-lg">{user.fullName || 'Anonymous User'}</h3>
                          {user.location && (
